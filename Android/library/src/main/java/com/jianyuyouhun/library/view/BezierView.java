...
public class BezierView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        current_x = event.getX()-mWidth/6;
        current_y = event.getY()-mHeight/2;
        invalidate();
        return true;
    }
...
//        circle.center[0] = maxLength * mInterpolatedTime;
        circle.center[0] = current_x;
//        circle.center[1] = current_y;
        ...
        for (int i = 2, l = circlePaths.size(); i < l; i++) {
